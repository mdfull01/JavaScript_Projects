...
const Perform_Calculation = { //describes how to handle operator input button string values from calculator.html  
...
function Calculator_Reset() { //Declare Calculator_Reset function, it changes Calculator properties back to 
    //values defined at load
...
//find (first) element class = calculator-screen replace its contents with current value of Display_Value
